...
(
    ...
    senha_sala VARCHAR(255) NOT NULL,
...
CREATE TABLE respostas(
    ...
    quant_respondida INT UNSIGNED NOT NULL,
...
-- @block
SELECT texto_pergunta,texto_resposta,quant_respondida FROM respostas 
...
WHERE questionarios.id_questionario = 3
;

-- @block
SELECT questionarios.id_questionario,questionarios.texto_questionario from questionarios
